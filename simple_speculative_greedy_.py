...
def generate_speculative_greedy(
    ...
    while generated < max_new_tokens:
        ...
        accepted, all_accepted, correction, bonus, target_predictions = verify_draft_greedy(
            target_model, tokens, draft
        )
...
def main():
    ...
    # Toy demo: 复制 target 作为 draft，再轻微扰动，让两者“相似但不完全一样”
    ...
    baseline = generate_target_greedy(
        target_model, input_ids, max_new_tokens=max_new_tokens
    )
    print(baseline)
